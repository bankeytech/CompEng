      ...
      <div className='pl-8 flex flex-col gap-8 w-full'>
        ...
        <div className='flex gap-4'>
          <div className='flex flex-col w-[65%]'>
            <div className='bg-[#914272] rounded-[1.1vw] flex items-center justify-between px-5 py-2 pl-7 text-white '>
          ...
          <div className='w-[35%] '>
            <div className='bg-[#914272] rounded-[1.1vw] flex flex-col items-center justify-between p-1 text-white h-screen'>
              <div className='flex flex-col'>
